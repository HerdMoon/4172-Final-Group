...
Mobile platforms:_ , OS versions:_ , device names:_ , server platform:_
Project title:_
...
Special instructions for deploying app:_
...
Video URL:_
Instructions for using app: new users should use the Scan Drawer function to scan all drawers with image target, so that the system knows the positions of them. (Reminder of which target to use: _)
